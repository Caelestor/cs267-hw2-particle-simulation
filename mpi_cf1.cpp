...
{    
    ...
    double time_commu1 = 0.0;
    double time_commu2 = 0.0;
    ...
    for( int step = 0; step < NSTEPS; step++ )
    {
        ...
        // int local_offsets[n_proc];       ////////////////////////// For Alltoallv!!!
        ...
        if ( (step +1)%SAVEFREQ == 0 and rank == 0)
        {
            time_commu2 =  read_timer() - time_commu1;
        ...
        if ( (step +1)%SAVEFREQ == 0 and rank == 0)
        {
            ...
            fprintf(fsave, "%f,%f,%f,%f,%f\n", time_binning, time_commu1, time_commu2, time_computing, time_moving);
        }
